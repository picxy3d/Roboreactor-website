	...
	<div class="hero-content text-center">
		<div class="max-w-7xl">
			...
			<Saos animation={'fade-in-bottom 1s'}>
				<div class="my-10 w-[90vw] min-w-[600px] overflow-x-auto">
					<table class="table w-full">
						<thead>
							<tr>
								<th />
								<th>
									<div class="card w-fit bg-base-100 shadow-sm shadow-info/20">
										<div class="card-body">
								...
								<th>
									<div class="card w-fit bg-base-100 shadow-sm shadow-success/20">
										<div class="card-body">
											<h2 class="card-title justify-center">Professional</h2>
											<div class="card-actions justify-center">
								...
								<th>
									<div class="card w-fit bg-base-100 shadow-sm shadow-base-content/20">
										<div class="card-body">
						...
						<tbody>
							<tr>
								<th>generate code with<br /> node Generator</th>
								<td>python</td>
								<td>python</td>
							...
							<tr>
								<th>single board computer and <br /> microcontroller support</th>
							...
							<tr>
								<th> lidar radar and <br />advance navigation system </th>
								<td />
								<td><span class="icon-[ic--baseline-check] h-4 w-4" /></td>
								<td><span class="icon-[ic--baseline-check] h-4 w-4" /></td>
							</tr>
							<tr>
								<th> realtime 3D motion control and <br />navigation visualizer</th>
								<td />
								<td><span class="icon-[ic--baseline-check] h-4 w-4" /></td>
								<td><span class="icon-[ic--baseline-check] h-4 w-4" /></td>
							</tr>
