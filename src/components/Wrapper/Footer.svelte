...
<footer
	class="footer z-50 border-t-[0.5px] border-neutral-content/10 bg-neutral p-10 text-neutral-content"
>
	<div>
	...
	<div>
		...
		Number: 10/2
		<br />
		Alley: Preedee phranomyong2 phrakhanong
		<br />
		Road: Sukhumvit71
		<br />
		District: Watthana
		...
		Country: Thailand
		<br />
		Postoffice code: 10110
	</div>
	<div>
		<span class="footer-title">Contacts</span>
		support@idatabots.com
		<br />
		+66970762483
	</div>
	<div>
